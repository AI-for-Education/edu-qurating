...
# QuRater Core Educational Scorer (Qwen3 4B)

Model repository: `AI-for-Education/qurater_Qwen3-Reranker-4B-seq-cls_ds-ours_v2-200000`
...
The newer naming convention for this model family is `edu-qurating-core-ed-*`; this card keeps the exact legacy repository id for compatibility with existing artifacts.
...
model_name = "AI-for-Education/qurater_Qwen3-Reranker-4B-seq-cls_ds-ours_v2-200000"
